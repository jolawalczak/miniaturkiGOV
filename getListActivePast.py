...
url = f"https://dane.biznes.gov.pl/api/ceidg/v3/firmy?status=AKTYWNY&status=WYLACZNIE_W_FORMIE_SPOLKI&dataod={past_date}&datado={past_date}&page={page}"
...
if responseType == "JSON":
    ...
    output_file = f"data-active-past/3LATA-AKTYWNE_{past_date}.csv"
